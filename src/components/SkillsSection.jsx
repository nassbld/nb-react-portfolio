...
const categories = [
    { label: "Langages", data: skills.languages },
    { label: "Frameworks", data: skills.frameworks },
    { label: "Architecture & Méthodologies", data: skills.architecture },
    { label: "Bases de données", data: skills.databases },
    { label: "Outils", data: skills.tools },
];

export default function SkillsSection() {
    return (
        <section id="skills" className="px-6 max-w-6xl mx-auto py-24">
            <SectionTitle label="Ma stack" title="Compétences" />
